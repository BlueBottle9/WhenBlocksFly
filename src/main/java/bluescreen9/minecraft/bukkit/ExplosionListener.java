package bluescreen9.minecraft.bukkit;
						...
						for (int x =-yield;x < yield;x++) {
							for (int y =-yield;y < yield;y++) {
								for (int z =-yield;z < yield;z++) {
									...
									if (type.equals(Material.AIR) || type.equals(Material.CHEST) || type.equals(Material.BEDROCK) || type.equals(Material.TNT) || type.equals(Material.BARRIER) || type.equals(Material.NETHER_PORTAL) || type.equals(Material.END_PORTAL) || type.equals(Material.END_PORTAL_FRAME)) {
										continue;
									}
									blocks.add(block);
								}
